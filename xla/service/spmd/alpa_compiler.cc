...
#include "xla/service/spmd/auto_sharding.h" // ok
#include "xla/service/spmd/auto_sharding_util.h"  // ok
#include "xla/service/spmd/grad_acc_rewrite.h"  // ok
#include "xla/service/spmd/redundant_slice_eliminator.h"  // ok
#include "xla/service/spmd/slice_auto_sharded_stages.h" // ok
#include "xla/service/spmd/stateful_rng_spmd_partitioner.h" // ok
...
#include "xla/hlo/transforms/hlo_constant_splitter.h"  // repalce service with xla/hlo/transforms temporarily.
#include "xla/service/hlo_cse.h"
#include "xla/service/hlo_dce.h"
#include "xla/service/hlo_pass_fix.h"
#include "xla/service/hlo_pass_pipeline.h"
#include "xla/hlo/ir/hlo_sharding_metadata.h"    // no such file, replace service with xla/hlo/ir temporarily.
...
const char kAfterAutoShardingDumpName[] = "after_run_auto_sharding";
const char kBeforeSpmdPartitionDumpName[] = "before_run_spmd_partitioner";
const char kAfterSpmdPartitionDumpName[] = "after_run_spmd_partitioner";
  ...
  */
  ...
  if (hlo_module->config().use_spmd_partitioning()) {
    ...
    if (num_partitions > 1) {
      ...
      // absl::Span<const bool> asspto({true}, 1);
