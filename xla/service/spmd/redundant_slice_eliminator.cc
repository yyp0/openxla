...
#include "xla/hlo/ir/hlo_instruction.h"   // replce service with hlo/ir
#include "xla/hlo/ir/hlo_instructions.h"    // replace service with hlo/ir
#include "xla/hlo/ir/hlo_opcode.h"   // replace service with hlo/ir
      ...
      if (ins->opcode() == HloOpcode::kDynamicSlice) {
        ...
        if (operand->opcode() == HloOpcode::kBroadcast) {
          ...
          if (is_redundant) {
            ...
            HloInstruction* new_ins =
                ins->parent()->AddInstruction(HloInstruction::CreateBroadcast(
                    ...
                    operand->dimensions()));
            TF_CHECK_OK(ins->ReplaceAllUsesWith(new_ins));
          }
          ...
          if (match) {
            ...
            TF_CHECK_OK(ins->ReplaceAllUsesWith(reshape_ins));
          }
